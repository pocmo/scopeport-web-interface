...
class HostsController < ApplicationController
  ...
  def get_host_sensors_hash host
      { "outdated" => host.outdated?,
        "id" => host.id,
        "name" => host.name,
        "profile_hostname" => getLastSensorValue(host.id, "profile_hostname"),
        "profile_domainname" => getLastSensorValue(host.id, "profile_domainname"),
        "profile_kernel" => getLastSensorValue(host.id, "profile_kernel"),
        "profile_total_memory" => getLastSensorValue(host.id, "profile_total_memory"),
        "profile_total_swap" => getLastSensorValue(host.id, "profile_total_swap"),
